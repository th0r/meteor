...
Template.api.accounts_config = {
  ...
  options: [
    ...
    },
    {
      name: "oauthSecretKey",
      type: "String",
      descr: "При использовании пакета `oauth-encryption` здесь указывается 16-ти байтовый ключ, необходимый для зашифровки конфиденциальных учетных данных, хранящихся в БД. Эта опция может быть указана только на сервере. Подробнее об этом можно узнать в файле packages/oauth-encryption/README.md."
    }
  ]
};
